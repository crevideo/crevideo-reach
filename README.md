...
> 1 base skill + 8 business-scenario skills + Crevideo Reach MCP (89 tools) + 5 scheduled-task templates + 2 Project Instructions
...
2. **MCP tools auto-connect** — first tool call pops a browser → OAuth to app.crevideo.com → log in to your Reach account → you can use all 89 tools
...
### 🟢 MCP Server: `crevideo-reach` (89 tools)
